...
class ConfidencialityWidget extends StatefulWidget {
  ConfidencialityWidget({Key key}) : super(key: key);

  @override
  _ConfidencialityWidgetState createState() => _ConfidencialityWidgetState();
}

class _ConfidencialityWidgetState extends State<ConfidencialityWidget> {
                ...
                child: StreamBuilder<List<YasalRecord>>(
                  stream: queryYasalRecord(
                    queryBuilder: (yasalRecord) =>
                        yasalRecord.where('no', isEqualTo: 3),
                    singleRecord: true,
                  ),
