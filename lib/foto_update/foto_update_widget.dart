...
class FotoUpdateWidget extends StatefulWidget {
  FotoUpdateWidget({
    Key key,
    this.postid,
  }) : super(key: key);
  ...
  @override
  _FotoUpdateWidgetState createState() => _FotoUpdateWidgetState();
}

class _FotoUpdateWidgetState extends State<FotoUpdateWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<PostsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final fotoUpdatePostsRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
