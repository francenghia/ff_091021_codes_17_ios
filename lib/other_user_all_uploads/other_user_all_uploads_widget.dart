...
class OtherUserAllUploadsWidget extends StatefulWidget {
  OtherUserAllUploadsWidget({
    Key key,
    this.otheruserid,
  }) : super(key: key);

  final DocumentReference otheruserid;

  @override
  _OtherUserAllUploadsWidgetState createState() =>
      _OtherUserAllUploadsWidgetState();
}

class _OtherUserAllUploadsWidgetState extends State<OtherUserAllUploadsWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final otherUserAllUploadsUsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                        ...
                        child: StreamBuilder<List<PostsRecord>>(
                          stream: queryPostsRecord(
                            queryBuilder: (postsRecord) => postsRecord
                                ...
                                .where('user', isEqualTo: widget.otheruserid)
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0),
                                                            child: Text(
                                                              '${socialFeedPostsRecord.ulke} ${socialFeedPostsRecord.il}',
                                                              style:
                                                                  FlutterFlowTheme
                                                                      .bodyText1
                                                                      .override(
