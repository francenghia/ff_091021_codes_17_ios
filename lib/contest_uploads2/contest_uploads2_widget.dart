...
class ContestUploads2Widget extends StatefulWidget {
  ...
  final DocumentReference contestid;
  final String costestname;

  @override
  _ContestUploads2WidgetState createState() => _ContestUploads2WidgetState();
}

class _ContestUploads2WidgetState extends State<ContestUploads2Widget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final contestUploads2UsersRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                              ...
                              try {
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      title: Text('Yarışma Koşulları'),
                                      content: Text(
                                          'Kazanan paylaşım minimum 50 beğeni (like) almak zorunda.'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
                        ...
                        child: StreamBuilder<List<PostsRecord>>(
                          stream: queryPostsRecord(
                            queryBuilder: (postsRecord) => postsRecord
                                ...
                                .where('attendant_contest',
                                    arrayContains: widget.contestid)
                                                            ...
                                                            padding:
                                                                EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        0),
                                                            child: Text(
                                                              '${socialFeedPostsRecord.ulke} ${socialFeedPostsRecord.ilce}',
                                                              style:
                                                                  FlutterFlowTheme
                                                                      .bodyText1
                                                                      .override(
